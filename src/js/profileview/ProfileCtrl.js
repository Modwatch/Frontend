(() => {
  ...
  ProfileCtrl.$inject = ["$rootScope", "$location", "$modal", "localStorageService", "APIService", "$routeParams"];

  function ProfileCtrl($rootScope, $location, $modal, localStorageService, APIService, $routeParams) {
